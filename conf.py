...
author = 'Felix Shaw, Toni Etuk, Alice Minotto, Robert Davey'
...
latex_documents = [
    (master_doc, 'copo-project.tex', 'copo-project Documentation',
     'Felix Shaw, Toni Etuk, Robert Davey', 'manual'),
]
...
man_pages = [
    (master_doc, 'copo-project', 'copo-project Documentation',
     [author], 1)
]
