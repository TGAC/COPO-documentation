...
copyright = '2017-2024, Collaborative OPen Omics (COPO). Licensed under Apache License 2.0'
...
document_title = 'Collaborative OPen Omics (COPO) Project Documentation'
document_description = ('A website portal where scientists describe their research objects using community-sanctioned '
                        'metadata sets and vocabularies')

# Grouping the document tree into LaTeX files. List of tuples
# (source start file, target name, title,
#  author, documentclass [howto, manual, or own class]).
latex_documents = [
    (master_doc, 'copo-project.tex', document_title,
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'copo-project', document_title,
     [author], 1)
]
