...
.. note::
  ...
  * **DTOL** [#f1]_  manifest submission can only be done via a :abbr:`ToL (Tree of Life)` [#f2]_ profile [#f3]_. Please see:
...
.. figure:: /assets/images/profile/profile_tol_profile_actions_dtol_submit_sample_manifest.png
  :alt: 'Submit DTOL/ASG manifest' profile action
  :align: center
  :height: 60ex
  :target: https://raw.githubusercontent.com/collaborative-open-plant-omics/Documentation/main/assets/images/profile/profile_tol_profile_actions_dtol_submit_sample_manifest.png
  :class: with-shadow with-border
